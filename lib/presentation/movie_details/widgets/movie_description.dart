                ...
                Padding(
                  ...
                  child: Row(
                    children: List.generate(
                      ...
                      (index) => Text(
                        '-${widget.movieDetails.genres[index]} ',
                        style: Theme.of(context)
                            .textTheme
                            .bodyMedium!
                            .copyWith(color: kGreyTextColor),
            ...
            child: Row(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: List.generate(
                      widget.movieDetails.spokenLanguages.length,
                      (index) => Text(
                        '-${widget.movieDetails.spokenLanguages[index]} ',
                        style: Theme.of(context)
                            .textTheme
                            .bodyMedium!
                            .copyWith(color: kGreyTextColor),
            ...
            child: Row(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: List.generate(
                      widget.movieDetails.productionCountries.length,
                      (index) => Text(
                        '-${widget.movieDetails.productionCountries[index]} ',
                        style: Theme.of(context)
                            .textTheme
                            .bodyMedium!
                            .copyWith(color: kGreyTextColor),
                ...
                Padding(
                  ...
                  child: Row(
                    children: List.generate(
                      ...
                      (index) => Text(
                        '-${widget.movieDetails.productionCompanies[index]} ',
                        style: Theme.of(context)
                            .textTheme
                            .bodyMedium!
                            .copyWith(color: kGreyTextColor),
